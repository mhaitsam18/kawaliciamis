        ...
        <div class="box box-warning box-solid">
            ...
            <form enctype="multipart/form-data" action="<?php echo $action; ?>" method="post">
                ...
                <table class='table table-bordered>'        
                       ...
                       <tr><td width='200'>Nama Puskesmas <?php echo form_error('nama_rumah_sakit') ?></td><td><input type="text" class="form-control" name="nama_rumah_sakit" id="nama_rumah_sakit" placeholder="Nama Puskesmas" value="<?php echo $nama_rumah_sakit; ?>" /></td>
                    ...
                    <tr><td width='200'>Provinsi <?php echo form_error('propinsi') ?></td><td><input type="text" class="form-control" name="propinsi" id="propinsi" placeholder="Propinsi" value="<?php echo $propinsi; ?>" /></td></tr>
