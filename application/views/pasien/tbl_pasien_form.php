            ...
            <form action="<?php echo $action; ?>" method="post">
                ...
                <table class='table table-bordered>'        
                    ...
                    <tr><td width='200'>Golongan Darah <?php echo form_error('golongan_darah') ?></td><td>
                            <?php echo form_dropdown('golongan_darah', array('A' => 'A', 'B' => 'B', 'O' => 'O', 'AB' => 'AB'), $golongan_darah, array('class' => 'form-control')); ?>
                    ...
                    <tr><td width='200'>Pekerjaan Orang Tua<?php echo form_error('id_pekerjaan') ?></td><td>
