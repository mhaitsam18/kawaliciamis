...
class Pendaftaran extends CI_Controller
{
    ...
    function cetak_riwayat_labor(){
        ...
        $pdf->Image(base_url().'assets/foto_profil/'.  getInfoRS('logo'),5,3,22);
        //$pdf->Image($file, $x, $y, $w, $h)
        
        // mencetak string 
        $pdf->Cell(190, 7, getInfoRS('nama_rumah_sakit'), 0, 1, 'C');
        $pdf->SetFont('Arial', '', 12);
        $pdf->Cell(190, 6, 'Jl. Siliwangi No.264, Kawalimukti, Kawali ', 0, 1, 'C');
         $pdf->Cell(190, 6, 'Kabupaten Ciamis, Jawa Barat 46253', 0, 1, 'C');
        $pdf->Cell(190, 6, 'Phone: (0265) 791132', 0, 1, 'C');
        ...
        // data pasien
         ...
         $pdf->Cell(120,5,'',0,0);
         $pdf->Cell(50,5,'Norisa Erliana Verdian Putri',0,1,'C');
